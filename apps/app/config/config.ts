...
//api
export const AuthApi = 'http://localhost:4000/client'
export const GRAPHQL = 'http://localhost:4000/graphql/client'
export const PUBLIC_GRAPHQL = 'http://localhost:4000/graphql/public_client'
